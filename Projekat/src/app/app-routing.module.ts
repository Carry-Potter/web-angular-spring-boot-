...
const routes: Routes = [
  ...
  { path: "zvanja", component: ZvanjeComponent , canActivate: [AuthGuard], data: {allowedRoles: ["ROLE_ADMIN", "ROLE_USER"]}},
  { path: "tipzvanja", component: TipZvanjaComponent , canActivate: [AuthGuard], data: {allowedRoles: ["ROLE_ADMIN", "ROLE_USER"]}},
  ...
  { path: "mesta", component: MestoComponent , canActivate: [AuthGuard], data: {allowedRoles: ["ROLE_ADMIN", "ROLE_USER"]}},
  { path: "adrese", component: AdresaComponent , canActivate: [AuthGuard], data: {allowedRoles: ["ROLE_ADMIN", "ROLE_USER"]}},
